...
export default function SuccessAmbilScreen({ navigation, route }) {
  ...
  const handleDone = async () => {
          ...
          .insert([
            {
              ...
              status: 'Selesai' // Status untuk pesanan yang diambil
            }
          ]);
    ...
    // Setelah tersimpan, baru kembali ke Home
...
const styles = StyleSheet.create({
  ...
  backBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#E0E0E0', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 15 },
  ...
  circleOuter: { width: 120, height: 120, borderRadius: 60, backgroundColor: '#3498DB', justifyContent: 'center', alignItems: 'center' },
  circleInner: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center' },
  receiptCard: { backgroundColor: '#8AB6D6', width: '90%', borderRadius: 25, padding: 20, elevation: 5 },
  mainTitle: { color: '#fff', fontSize: 22, fontWeight: 'bold', textAlign: 'center', marginBottom: 20, lineHeight: 30 },
  whiteBox: { backgroundColor: '#fff', borderRadius: 20, padding: 20 },
  ...
  footerNote: { textAlign: 'center', color: '#999', fontSize: 13, marginTop: 10, marginBottom: 15 },
  saveBtn: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#3498DB', padding: 8, borderRadius: 10 },
  saveBtnText: { color: '#3498DB', marginLeft: 8, fontWeight: 'bold' },
  doneBtn: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#2C3E50', padding: 20, alignItems: 'center' },
